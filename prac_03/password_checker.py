...
def is_valid_password(password):
    ...
    # Initialize counters for different character requirements
    number_of_lower = 0
    number_of_upper = 0
    number_of_digit = 0
    number_of_special = 0
    ...
    # Check that the password has at least one lowercase, one uppercase, and one digit
    if number_of_lower == 0 or number_of_upper == 0 or number_of_digit == 0:
        return False

    # Check if special characters are required and if present
